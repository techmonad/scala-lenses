...
final case class Address(no: String, street: String, post: String)

final case class Department(id: UUID, name: String, address: Address)

final case class Employee(id: UUID, name: String, address: Address, department: Department)
